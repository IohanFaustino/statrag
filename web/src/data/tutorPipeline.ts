...
export const TUTOR_PIPELINE: { nodes: PipelineNode[]; edges: PipelineEdge[] } = {
  nodes: [
    ...
    },
    {
      ...
      desc: "Fetches one Wikipedia summary per concept (always-on; TUTOR_DEEP_WIKI=0 disables) and appends them AFTER the corpus sources at trailing ranks — corpus stays the authority. Pure code, no LLM; silent-degrade on network failure; skipped entirely when the corpus returned nothing.",
      kind: "data",
      stage: null,
      locked: true,
