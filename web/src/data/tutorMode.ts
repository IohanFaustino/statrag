...
export const TUTOR_MODE = {
  ...
  features: [
    { label: "Multi-aspect answer", detail: "Introduction, Definition, Formal statement (only when a numbered theorem exists in the sources), Example & Intuition, Applications, Further reading." },
    ...
    { label: "Verbatim theorems", detail: "Reproduces a book's stated definition/theorem word-for-word when available, else an indirect citation." },
