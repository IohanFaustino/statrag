...
Emits (relative to this dir): index.html (comparison table) + <safe-id>.html per
model (16). Nav lives in ../sidebar.js (hand-maintained toggle config) — not here.
"""
...
def main() -> None:
    # NOTE: ../sidebar.js is hand-maintained (toggle nav incl. Modes) — not emitted here.
